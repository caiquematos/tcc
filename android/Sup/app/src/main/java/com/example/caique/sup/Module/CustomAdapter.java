package com.example.caique.sup.Module;
...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.ViewHolder>{
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements HandleConnection {
        ...
        public ViewHolder(View v) {
            ...
            if (mSwitch != null)
                mSwitch.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (mDataSet[getAdapterPosition()].getStatus() == '1') moduleRequest(mDataSet[getAdapterPosition()].getId(), 0, mUser);
                        else moduleRequest(mDataSet[getAdapterPosition()].getId(), 1, mUser);
                    }
                });
        ...
        private void moduleRequest(int module, int status, int user) {
            AsyncTask<String, Void, Request> switchRequest = new AsyncTask<String, Void, Request>() {
                ...
                protected Request doInBackground(String... strings) {
                    ...
                    request.setResponse(Methods.Post2(mContext, nameValuePairs, "module/status"));
                    return request;
                }
            ...
            switchRequest.execute(String.valueOf(module), String.valueOf(status), String.valueOf(user));
        }
