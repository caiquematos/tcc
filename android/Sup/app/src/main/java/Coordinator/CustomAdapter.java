                ...
                mSwitch.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (mDataSet[getAdapterPosition()].getStatus() == '1')
                            switchCoordinator(mDataSet[getAdapterPosition()].getId(), 0);
                        else switchCoordinator(mDataSet[getAdapterPosition()].getId(), 1);
                    }
                });
            ...
            AsyncTask<String, Void, Request> switchRequest = new AsyncTask<String, Void, Request>() {
                ...
                protected Request doInBackground(String... params) {
                    try {
                        ...
                        request.setResponse(Methods.POST(mContext, rawJson, "coordinator/switch"));
                        return request;
